...
The directory serves to collate information about publishers, platforms, distributors, and ordering systems. It can now be found as a separate project, through the following link: https://github.com/josha-wah/The-Radical-Pages 

## Text Catalogue

If you'd like to take part in the cataloguing of texts for this project, you may submit entries or suggest edits for existing ones either as an "issue" or "pull request". See the example below for cataloguing requirements:
